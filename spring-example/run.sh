...
/usr/lib/jvm/jdk-9/bin//java -XaddReads:com.github.ishestakov.coe=ALL-UNNAMED -cp 'lib/*:main/resources:mod/*' -mp 'bin/java9' -m com.github.ishestakov.coe/com.github.ishestakov.coe.Main
